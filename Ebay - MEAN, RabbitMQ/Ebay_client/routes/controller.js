...
// require("../../Ebay_server/models/mongoose");
// var users = require('../../Ebay_server/models/users');
...
function signOut(request, response) {
    ...
    console.log("in signout request");
...
function addItem(request, response) {
    ...
    console.log("in additem request");
...
function getItem(request, response) {
    ...
    console.log("in getitem request");
...
function getSellerInfo(request, response) {
    ...
    console.log("in getsellerinfo request");
...
function getRecentAds(request, response) {
    ...
    console.log("in gerecentads request");
...
function getCart(request, response) {
    ...
    console.log("in getcart request");
...
function addToCart(request, response) {
    ...
    console.log("in addtocart request");
...
function removeFromCart(request, response) {
    ...
    console.log("in removefromcart request");
...
function checkout(request, response) {
    ...
    console.log("in checkout request");
...
function fetchUserOrders(request, response) {
    ...
    console.log("in fetchuserorders request");
...
function fetchUserAds(request, response) {
    ...
    console.log("in fetchuserads request");
...
function editCart(request, response) {
    ...
    console.log("in editcart request");
...
function getIdentity(request, response) {
    ...
    console.log("in getidentity request");
...
function fetchUserBids(request, response) {
    ...
    console.log("in fetchuserbids request");
...
function editProfile(request, response) {
    ...
    console.log("in editprofile request");
...
function getItemBids(request, response) {
    ...
    console.log("in getitembids request");
...
function getMaxBid(request, response) {
    ...
    console.log("in getmaxbid request");
...
function searchItems(request, response) {
    ...
    console.log("in searchitems request");

    var search_string = request.body.searchString;
    search_string = search_string.toLowerCase().replace(/[^a-z0-9\040]*/g, '');
    var msg_payload = {"search_string": search_string};
    ...
    mq_client.make_request("search_queue", msg_payload, function(err, results){
        ...
        if (!err) {
            ...
            response.status(200);
            response.end(JSON.stringify(results.ads));
