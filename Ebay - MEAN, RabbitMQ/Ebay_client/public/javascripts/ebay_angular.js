    ...
    if (ad_id == "Unknown") {
        ...
        $http({
            ...
            .success(function (data) {
                ...
                $scope.seller_id = data.seller._id;
                $scope.seller_handle = data.seller.handle;
                ...
                timer((data.bid_end - milliseconds)/1000);
                ...
                if ($scope.bid_enabled == 1) {
                    ...
                    $http({
                        ...
                        .then(function success(maxbid) {
                                // $scope.maxbids = data.data;
                            // console.log(data);
                                $scope.max_bid = maxbid.data.bid_price;
        ...
        if ($scope.buy_now) {
            ...
            if (parseInt($scope.user_input) > $scope.item_quantity || parseInt($scope.user_input) < 1) {
                ...
                $http({
                    ...
                    data: {
                        "item_id": ad_id,
                        "item_seller_id": $scope.seller_id,
